...
class StockService(
    ...
    fun getDailyStockPrice(
        ...
        kisRealClient
            .getDailyStockPrice(stockCode, startDate, endDate, adjustedPrice)
            .filter { it.resultCode == "0" }
            .flatMapMany { response ->
                Flux
                    .fromIterable(response.priceList)
    ...
    fun getMarketCapTop(
        ...
        return stockCodeRepository
            .findMarketCapTop(pageRequest)
