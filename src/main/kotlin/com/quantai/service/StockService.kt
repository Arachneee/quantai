...
import com.quantai.api.KisApiClient
...
@Service
class StockService(private val kisApiClient: KisApiClient) {
    ...
    fun getDailyStockPrice(
        ...
        return kisApiClient.getDailyStockPrice(stockCode, startDate, endDate, adjustedPrice)
    }
}
